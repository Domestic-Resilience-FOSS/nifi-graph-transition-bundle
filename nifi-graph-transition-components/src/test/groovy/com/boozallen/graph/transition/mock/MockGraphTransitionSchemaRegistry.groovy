...
class MockGraphTransitionSchemaRegistry extends MockSchemaRegistry implements GraphTransitionSchemaRegistry {
    private Map<String, Transition> transitions = [:]
    private ObjectMapper mapper = new ObjectMapper()

    MockGraphTransitionSchemaRegistry() {
        super()
    }

    void addMapping(String name, String mapping) {
        def result = mapper.readValue(mapping, Transition.class)
